...
use scriptorium::library_db::LibraryDb;
use scriptorium::pipeline::{Pipeline, ImportStatus};
use crate::pages;

pub fn build_ui(app: &adw::Application) {
    let provider = gtk::CssProvider::new();
    provider.load_from_data("flowboxchild:selected box.card { background-color: alpha(@theme_selected_bg_color, 0.3); outline: 2px solid @theme_selected_bg_color; }");
    ...
    let db_path = scriptorium::default_db_url();
